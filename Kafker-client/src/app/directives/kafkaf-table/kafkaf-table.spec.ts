...
import { kafkerTableDirective } from './kafker-table';
import { TestBed } from '@angular/core/testing';

describe('kafkerTableDirective', () => {
  let mockLogger: { warn: jasmine.Spy };
  let mockRenderer: jasmine.SpyObj<Renderer2>;
  let directive: kafkerTableDirective;
  ...
  beforeEach(() => {
    ...
    directive = TestBed.inject(kafkerTableDirective);
  });
